...
The original licensing conditions of IFC and IfcOwl apply.

In particular, the "ND" (no derivative) clause applying to IFC4.3 ADD2 precludes any EXPRESS-to-OWL transformation. IFC4.3 ADD2 is the version of interest in the context of the CDM, as it deals in particular with railway alignment. The corresponding works (transformation and linking with the CDM) cannot be published.
